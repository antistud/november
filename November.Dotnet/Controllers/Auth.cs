            ...
            if (CheckSessionId() != false)
            {
                ...
                if (rgx.IsMatch(body.email) == true)
                {
                    ...
                    catch
                    {
                        ...
                        var sg_plainTextContent = "You have been invited to BoxShare username: " + body.email.ToLower() + " password: " + password + " URL: http://app.garishgames.com/login?e=" + body.email.ToLower() + "&p=" + password;
                        var sg_htmlContent = $"<strong>You have been invited to BoxShare.</strong><br><br>username: " + body.email.ToLower() + "<br>password: " + password + " <br><br> <a href='http://app.garishgames.com/login?e=" + body.email.ToLower() + "&p=" + password + "'>Go Now</a>";
